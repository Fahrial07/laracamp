...
<body>
    <section class="login-user">
        ...
        <div class="right" style="margin-top: -50px !important;">
            <img src="{{ asset('images/logo.png') }}" class="logo" alt="">
            <h1 class="header-third" style="margin-top: -50px !important;">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('manual.register') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mt-2">
                            <label for="form-label">Alamat Email</label>
            ...
            <p class="text-center">
                <a class="btn btn-border btn-google-login" href="{{ route('user.login.google') }}">
                    <img src="{{ asset('images/ic_google.svg') }}" class="icon" alt=""> Register with Google
                </a>
            </p>
