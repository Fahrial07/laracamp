                        ...
                        <div class="col-lg-6 col-12">
                            <form action="{{ route('checkout.store', $camps->id) }}" method="POST" class="basic-form">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="name" type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : ''}}" value="{{ Auth::user()->name }}" readonly required>
                                    @if ($errors->has('name'))
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="email" type="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : ''}}" value="{{ Auth::user()->email }}" readonly required>
                                    @if ($errors->has('email'))
