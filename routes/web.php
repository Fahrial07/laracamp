...
//socialite routes
Route::get('register/user', [ManualRegisterController::class, 'index'])->name('register.user');
Route::post('manual/register', [ManualRegisterController::class, 'store'])->name('manual.register');
